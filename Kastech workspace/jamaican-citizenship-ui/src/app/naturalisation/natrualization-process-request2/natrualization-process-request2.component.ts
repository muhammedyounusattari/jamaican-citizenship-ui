...
@Component({
  selector: 'app-natrualization-process-request2',
  templateUrl: './natrualization-process-request2.component.html',
  styleUrls: ['./natrualization-process-request2.component.css']
})
export class NatrualizationProcessRequest2Component implements OnInit {
  ...
  this.process2 = this.formBuilder.group({ 
 ...
 //  }
  ...
  back(){
    ...
    this.router.navigate(['/naturalisation']) 
  }
  next(){
    localStorage.setItem('process1',JSON.stringify(this.process2.value));
    if(this.nonEdittable)
