...
@Component({
  selector: 'app-natrualization-process-request3',
  templateUrl: './natrualization-process-request3.component.html',
  styleUrls: ['./natrualization-process-request3.component.css']
})
export class NatrualizationProcessRequest3Component implements OnInit {
  ...
  this.process3 = this.formBuilder.group({ 
    ...
    residentfrom1: [this.utilityService.formatDate(this.nullCheck(processStorage.residentfrom1)),],
    residentto1: [this.utilityService.formatDate(this.nullCheck(processStorage.residentto1)),],
    residentaddress2: [this.nullCheck(processStorage.residentaddress2),],
    residentfrom2: [this.utilityService.formatDate(this.nullCheck(processStorage.residentfrom2)),],
    residentto2: [this.utilityService.formatDate(this.nullCheck(processStorage.residentto2)),],
    residentaddress3: [this.nullCheck(processStorage.residentaddress3),],
    residentfrom3: [this.utilityService.formatDate(this.nullCheck(processStorage.residentfrom3)),],
    residentto3: [this.utilityService.formatDate(this.nullCheck(processStorage.residentto3)),],
